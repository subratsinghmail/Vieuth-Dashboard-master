...
export default function StudentOpportunityCard(props) {
    return (
        <MDBCol size="12" sm="6" md="3" className="mt-3">
            <MDBCard style={{ borderRadius: '12px', overflow: "hidden" }} >
                <div className="bg-dark">
                    <MDBCardImage className="mx-auto d-block" src={logo} waves alt="Card image cap" height='100px' />
                ...
                <MDBCardBody>
                    ...
                    <MDBCardText>
                        <MDBRow style={{ fontWeight: '400', display: 'flex', flex: 'left', marginLeft: '0.2rem' }}>
                            <small>{props.data.companyName} Company</small>
                        </MDBRow>
                        <MDBRow className="text-center mt-4">
                            <MDBCol size="6" sm="6" style={{ fontWeight: '700', fontSize: '0.8rem' }}>Apply Before </MDBCol>
                            <MDBCol size="6" sm="6" style={{ fontWeight: '300', fontSize: '0.8rem' }}>{props.data.expiry}</MDBCol>
                        </MDBRow>

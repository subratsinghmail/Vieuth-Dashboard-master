...
class Register extends Component {
  ...
  onSubmit = e => {
    ...
    client.mutate({
      mutation,
      variables: { fName: this.state.fName, lName: this.state.lName, email: this.state.email, password: this.state.password, gender: this.state.gender, dob: this.state.dob, role: this.state.role }
    }).then(res => {
